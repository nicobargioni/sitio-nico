...
Justamente porque está disuelto, casi nunca aparece en los procesos que la empresa cree tener. Es parte del abismo entre [el proceso que dibujaste y el que de verdad ocurre](/hiperautomatizacion/bpmn/proceso-real-vs-dibujado), y suele esconderse detrás del [happy path que tapa el 80% del trabajo real](/hiperautomatizacion/bpmn/happy-path-mentira).
...
1. **Es 100% basado en reglas.** "Leé este campo, escribilo en aquel otro." Sin ambigüedad, sin criterio. Exactamente lo que un bot —que [no es IA ni la necesita](/hiperautomatizacion/rpa/rpa-no-es-ia)— hace mejor que nadie.
...
3. **No hay API que lo resuelva fácil** —si la hubiera, el swivel chair no existiría—. Es el territorio donde [RPA entra por la ventana](/hiperautomatizacion/rpa/rpa-vs-api) porque la puerta nunca se construyó.
...
Pero el bot no arregla la enfermedad. Sigue habiendo dos sistemas desconectados, ahora unidos por una integración frágil que [se rompe con cualquier cambio de pantalla](/hiperautomatizacion/rpa/rpa-deuda-tecnica). Lo ideal:
